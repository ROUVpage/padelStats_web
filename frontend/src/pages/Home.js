        ...
        <div className="product-details-container">
          <div className="product-details-grid">
            ...
            <div className="product-details-image">
              <div className="product-details-image-container" style={{background:'transparent',display:'block'}}>
                <img src="/producto-nuevo.png" alt="PadelStats App" style={{width:'100%',height:'auto',display:'block',borderRadius:'0.5rem'}} />
              </div>
            </div>
          </div>
        </div>
