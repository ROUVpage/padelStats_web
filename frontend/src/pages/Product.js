          ...
          <div className="product-hero-grid">
            <div>
              <div className="product-image-container" style={{overflow:'hidden',padding:0}}>
                <img src="/demo-app.png" alt="PadelStats Sensor" style={{width:'100%',height:'100%',objectFit:'cover',objectPosition:'left center',transform:'scale(1.25)',transformOrigin:'right center',display:'block'}} />
              </div>
            </div>
            <div>
